# bg: example from Flux.jl, test/losses.jl
# TODO why no events in the final log???

# original output:
# ===
# Test Summary: | Pass  Total  Time
# xlogx & xlogy |    8      8  1.6s
# Test Summary: | Pass  Total  Time
# mse           |    2      2  0.6s
# Test Summary: | Pass  Total  Time
# mae           |    1      1  0.1s
...
# msle          |    1      1  0.1s
# Test Summary: | Pass  Total  Time
# crossentropy  |    9      9  1.4s
# Test Summary:     | Pass  Total  Time
# logitcrossentropy |    3      3  3.0s
# Test Summary:      | Pass  Total  Time
# binarycrossentropy |    4      4  1.4s
# Test Summary:           | Pass  Total  Time
# logitbinarycrossentropy |    2      2  0.2s
# Test Summary:   | Pass  Total  Time
# label_smoothing |    4      4  0.2s
# Test Summary: | Pass  Total  Time
# kldivergence  |    3      3  0.3s
# Test Summary: | Pass  Total  Time
# hinge_loss    |    2      2  0.3s
# Test Summary:      | Pass  Total  Time
# squared_hinge_loss |    2      2  0.2s
# Test Summary: | Pass  Total  Time
# poisson_loss  |    2      2  0.1s
# Test Summary:   | Pass  Total  Time
# dice_coeff_loss |    2      2  0.1s
# Test Summary: | Pass  Total  Time
# tversky_loss  |    3      3  0.4s
# Test Summary:          | Pass  Total   Time
# no spurious promotions |   68     68  35.5s
# Test Summary:     | Pass  Total  Time
# binary_focal_loss |    3      3  0.9s
# Test Summary: | Pass  Total  Time
# focal_loss    |    3      3  1.2s
# Test Summary:            | Pass  Total  Time
# siamese_contrastive_loss |   15     15  1.8s
...
# msle          |    1      1  0.1s
# Test Summary: | Pass  Total  Time
# crossentropy  |    9      9  1.8s
# Test Summary:     | Pass  Total  Time
# logitcrossentropy |    3      3  0.8s
# Test Summary:      | Pass  Total  Time
# binarycrossentropy |    4      4  1.4s
# Test Summary:           | Pass  Total  Time
# logitbinarycrossentropy |    2      2  0.2s
...
# label_smoothing |    4      4  0.2s
# Test Summary: | Pass  Total  Time
# kldivergence  |    3      3  0.2s
# Test Summary: | Pass  Total  Time
# hinge_loss    |    2      2  0.2s
# Test Summary:      | Pass  Total  Time
# squared_hinge_loss |    2      2  0.1s
# Test Summary: | Pass  Total  Time
# poisson_loss  |    2      2  0.1s
# Test Summary:   | Pass  Total  Time
# dice_coeff_loss |    2      2  0.1s
# Test Summary: | Pass  Total  Time
# tversky_loss  |    3      3  0.5s
# Test Summary:     | Pass  Total  Time
# binary_focal_loss |    3      3  0.7s
# Test Summary:            | Pass  Total  Time
# siamese_contrastive_loss |   15     15  1.2s


using Test
using Flux: onehotbatch, σ, logsoftmax, mean, softmax
...
y = TF([123.0,456.0,789.0])
ŷ = TF([345.0,332.0,789.0])
@testset "msle" begin
  @test Flux.msle(ŷ, y) ≈ 0.38813985859136585
end

# Now onehot y's
y = onehotbatch(TF([1, 1, 0, 0]), 0:1)
y_smoothed = label_smoothing(y, 0.1)
ŷ = TF([.1 .9; .9 .1; .9 .1; .1 .9]')
v = log(.1 / .9)
logŷ = TF([v 0.0; 0.0 v; 0.0 v; v 0.0]')
lossvalue = 1.203972804325936
lossvalue_smoothed = 1.2039728043259348
yl = onehotbatch(TF([1]), 0:1)
sf = 0.1
...
@testset "crossentropy" begin
  @test crossentropy(TF([0.1,0.0,0.9]), TF([0.1,0.0,0.9])) ≈ crossentropy([0.1,0.9], [0.1,0.9])
...
# bg ERROR sampler not defined
#@testset "no spurious promotions" begin
#  for T in (FloatTracker.TrackedFloat32, FloatTracker.TrackedFloat64)
#    y = rand(T, 2)
#    ŷ = rand(T, 2)
#    for f in ALL_LOSSES
...
#         0  1  0  1  0
#         0  0  1  0  0])
#    ŷ = TF(softmax(reshape(-7:7, 3, 5) .* 1f0))
#    y1 = TF([1 0
#          0 0
#          0 1])
#    ŷ1 = TF([0.4 0.2
...
@testset "siamese_contrastive_loss" begin
  ...
  y1 = TF([1 0 0 0 1
        0 1 0 1 0
        0 0 1 0 0])
  ŷ1 = softmax(reshape(-7:7, 3, 5) .* TF(1.0f0))
  y2 = TF([1
        0
        0
        1
